...
import { ComposerId } from "../../Configuration/MessageComposerConfiguration";
/**
...
export declare abstract class CometChatTextFormatter {
     ...
     */
    setInputElementReference(inputElementReference: any): void;
    /**
     * Sets the re-render function.
     * @param reRender - The function to call for re-rendering.
     */
    setReRender(reRender: any): void;
    /**
    ...
    debouncedFormatTextOnKeyUp: (...args: any[]) => void;
    /**
     ...
     */
    protected getPrecedingText(currentCaretPosition: any, currentRange: any): string | null;
    /**
     ...
     * @param {any} span - The HTML element to register event listeners.
     * @param {any} classList - The classList of the element.
     * @return {any} - The element with event listeners registered.
     */
    registerEventListeners(span: any, classList: DOMTokenList): any;
}
//# sourceMappingURL=CometChatTextFormatter.d.ts.map