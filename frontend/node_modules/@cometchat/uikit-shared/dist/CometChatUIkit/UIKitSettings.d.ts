...
import { CallingExtensionDataSource } from "../Extensions/CallingExtensionDataSource";
export declare class UIKitSettings {
    ...
    readonly callingExtension?: CallingExtensionDataSource;
    ...
    getCallingExtension(): CallingExtensionDataSource;
...
export declare class UIKitSettingsBuilder {
    ...
    callingExtension?: CallingExtensionDataSource;
    ...
    setCallingExtension(callExtension: CallingExtensionDataSource): UIKitSettingsBuilder;
