...
import { AvatarStyle } from "../CometChatAvatar/AvatarStyle";
...
export declare class CometChatListItem extends LitElement {
    ...
    /**
     * to change the position of use presence icon
     */
    userPresencePlacement: UserPresencePlacement;
    itemTitleContainer: any;
    tailViewContainer: any;
    menuViewContainer: any;
    dynamicTitleStyle: any;
    isHovering: boolean;
    tailSlot: any;
    menuSlot: any;
    hideShowTail: () => void;
    ...
    private updateDynamicTitleStyle;
    ...
    listItemStyles: {
        ...
        subtitleSlotStyle: (tailSlot: any, menuSlot: any) => {
            width: string;
        };
        titleStyle: (style: any) => any;
        tailViewStyle: (style: any) => {
            display: string;
        };
        menuViewStyle: (style: any) => {
            display: string;
        };
    };
}
