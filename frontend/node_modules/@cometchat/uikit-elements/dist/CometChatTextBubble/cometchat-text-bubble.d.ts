...
export declare class CometChatTextBubble extends LitElement {
    text: string;
    ...
    pasteHtml(textElement: any, html: any): void;
    textStyles(): {
        color: string;
        font: string;
    };
...
//# sourceMappingURL=cometchat-text-bubble.d.ts.map